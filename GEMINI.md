...
This file provides project-specific guidance for the **Catppuccin StarryNight** Spicetify theme.

## Rule Inheritance

This project adheres to the standards defined in the global and application-level Gemini configuration. This file contains **project-specific** overrides, conventions, and documentation.

- **Global Rules**: `~/.gemini/GEMINI.md` (and its modules)
- **Application Rules**: `~/Applications/GEMINI.md`
...
This project follows global development standards. Project-specific standards are detailed below.
...
### Naming Conventions
Refer to the global `DEVELOPMENT_STANDARDS.md` for base conventions. Project-specific examples:
...
This project follows the standard `DEVELOPMENT_WORKFLOWS.md`. Key project-specific steps are listed below.
