import { RightSidebarCoordinator } from "@/systems/visual/RightSidebarCoordinator";
...
describe("RightSidebarCoordinator", () => {
  let coordinator: RightSidebarCoordinator;

  beforeEach(() => {
    jest.clearAllMocks();
    coordinator = new RightSidebarCoordinator({
      enableDebug: false,
  ...
  describe("Singleton Pattern", () => {
    it("should return the same instance", () => {
      const instance1 = RightSidebarCoordinator.getInstance();
      const instance2 = RightSidebarCoordinator.getInstance();
  ...
  describe("Configuration", () => {
    it("should initialize with default config", () => {
      const defaultCoordinator = new RightSidebarCoordinator();
    ...
    it("should initialize with custom config", () => {
      const customCoordinator = new RightSidebarCoordinator({
        enableDebug: true,
        maxBatchSize: 25,
        performanceAnalyzer: mockPerformanceAnalyzer,
      });
