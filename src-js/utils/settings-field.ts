// Type definitions for StarryNight in-built settings framework
// This is a trimmed subset of the original spcr-settings typings – we only
// implement the shapes needed by our own theme.
