...
export class WhiteLayerFixUtils {
  ...
  static disableAberrationSystem(): void {
    ...
    if (aberrationCanvas) {
      ...
      Y3K?.debug?.log("WhiteLayerFixUtils", "Disabled chromatic aberration system");
    }
  }
  ...
  static enableAberrationSystemSafe(): void {
    ...
    if (aberrationCanvas) {
      ...
      Y3K?.debug?.log("WhiteLayerFixUtils", "Enabled chromatic aberration system with safe settings");
    }
  }
  ...
  static fixScreenBlendModes(): void {
    ...
    Y3K?.debug?.log("WhiteLayerFixUtils", `Fixed ${screenBlendElements.length} screen blend modes`);
  }
  ...
  static resetWebGLContexts(): void {
    ...
    Y3K?.debug?.log("WhiteLayerFixUtils", `Reset ${resetCount} WebGL contexts`);
  }
  ...
  static applyEmergencyWhiteLayerFix(): void {
    ...
    Y3K?.debug?.log("WhiteLayerFixUtils", "Applied emergency white layer suppression");
  }
  ...
  static removeEmergencyWhiteLayerFix(): void {
    ...
    Y3K?.debug?.log("WhiteLayerFixUtils", "Removed emergency white layer suppression");
  }
  ...
  static quickFixAllWhiteLayerIssues(): void {
    ...
    Y3K?.debug?.log("WhiteLayerFixUtils", "Applied all white layer fixes");
  }
  ...
  static applyZIndexFixes(): void {
    ...
    const gradientElements = document.querySelectorAll('.sn-webgl-gradient, .sn-css-gradient');
    ...
    const depthContainer = document.querySelector('.sn-depth-background-container') as HTMLElement;
    if (depthContainer) {
    ...
    Y3K?.debug?.log("WhiteLayerFixUtils", "Applied z-index fixes");
  }
  ...
  static diagnoseWhiteLayerIssues(): {
    ...
    Y3K?.debug?.log("WhiteLayerFixUtils", "White layer diagnosis:", diagnosis);
  ...
  static startWhiteLayerMonitoring(): void {
    ...
    monitor();
    Y3K?.debug?.log("WhiteLayerFixUtils", "Started white layer monitoring");
  }
}

// Export convenience functions
export const disableAberration = WhiteLayerFixUtils.disableAberrationSystem;
export const enableAberrationSafe = WhiteLayerFixUtils.enableAberrationSystemSafe;
...
export const startWhiteLayerMonitoring = WhiteLayerFixUtils.startWhiteLayerMonitoring;