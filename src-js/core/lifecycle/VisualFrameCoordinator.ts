// ============================================================================
// 🌌 COSMIC DISCOVERY FRAMEWORK – VisualFrameCoordinator (Phase 1)
// ----------------------------------------------------------------------------
...
//
// NOTE: This coordinator purposefully lives **outside** the existing
// AnimationConductor so that we can iterate without touching
// the mature scheduling logic.  In Phase 2 we may register the VFC itself
// as an AnimationSystem to AnimationConductor – for now it owns its own rAF loop.
//
...
export interface IVisualSystem {
  ...
  /** Optional hook when the coordinator toggles performance modes. */
  onPerformanceModeChange?(mode: "performance" | "quality"): void;
  /** Cleanup hook – called when system is unregistered or coordinator destroyed. */
  destroy(): void;
}
...
export class VisualFrameCoordinator {
...
// ========================================================================
// LEGACY ALIAS - VisualSystemRegistry (Deprecated)
// ========================================================================
// Temporary alias for backward compatibility during migration
// TODO: Remove after all references are updated

/** @deprecated Use VisualFrameCoordinator instead */
export const VisualSystemRegistry = VisualFrameCoordinator;